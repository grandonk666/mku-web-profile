...
@section('content')
  ...
  <form method="POST" action="{{ route('admin.struktur.update', $struktur) }}"
    ...
    <div class="mb-4">
      <label class="block text-sm text-gray-700" for="jabatan">Nama
        Jabatan</label>
      <input
        class="w-full px-5 py-1 text-gray-800 bg-gray-100 rounded outline-none border-2 border-gray-200 focus:border-gray-800 @error("
