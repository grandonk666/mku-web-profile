...
<form method="POST" action="{{ route("admin.matakuliah.update", $matakuliah) }}"
  ...
  <div class="mb-4">
    ...
    <input
      ...
      placeholder="Nama Matakuliah" aria-label="nama"
  ...
  <div class="mb-4">
    ...
    <input
      class="w-full px-5 py-1 text-gray-800 bg-gray-200 rounded outline-none border-2 border-gray-200 focus:border-gray-800 @error("
      kode") border-red-500 @enderror" id="kode" name="kode" type="text"
      placeholder="Kode Matakuliah" aria-label="Kode"
