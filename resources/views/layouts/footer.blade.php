    ...
    <div class="container mx-auto flex flex-col lg:flex-row justify-between gap-8 py-8">
      ...
      <div class="px-4 text-center">
        ...
        <ul class="text-gray-600 lg:text-right flex flex-col gap-1">
          <li><a href="{{ route("profil") }}/#visi-misi" class="hover:text-gray-800">Visi & Misi</a></li>
          <li><a href="#" class="hover:text-gray-800">Berita</a></li>
          <li><a href="#" class="hover:text-gray-800">Pengumuman</a></li>
          <li><a href="#" class="hover:text-gray-800">Kontak</a></li>
        </ul>
      </div>
    </div>
  </div>
  <div class="text-center py-6 text-gray-600">&copy; MKU UPN "Veteran" Jawa Timur</div>
</footer>